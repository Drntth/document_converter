"""
AI promptok és rendszerüzenetek a különböző feldolgozási lépésekhez.

Tartalmazza:
- Táblázat összefoglaló promptokat
- Képfeldolgozó promptokat
- Általános dokumentumfeldolgozó utasításokat
"""
